  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-6 md:p-12">
      <div className="max-w-6xl mx-auto">
        <div className="mb-10">
           <Link href="/dashboard" className="text-blue-600 font-bold text-sm flex items-center gap-1 hover:underline mb-4">
           ...
           <p className="text-gray-500 font-medium mt-2 text-lg">Select a specific Staff Selection Commission exam to view its Previous Year Questions and Mock Tests.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SSC_EXAMS.map(exam => (
            <Link 
              ...
              className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all group flex flex-col items-center text-center relative overflow-hidden"
            >
               ...
               <h3 className="text-xl font-black text-gray-900 mb-2">{exam.name}</h3>
               <p className="text-gray-500 font-medium text-xs mb-6">{exam.desc}</p>
               <div className="mt-auto px-5 py-2 bg-gray-50 text-gray-400 group-hover:bg-blue-600 group-hover:text-white rounded-full text-xs font-bold uppercase tracking-widest transition flex items-center">
