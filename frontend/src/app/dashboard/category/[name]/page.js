...
export default function CategoryQuizzesPage() {
  ...
  const QuizCard = ({ quiz }) => (
    <div className="bg-gray-50/50 p-6 rounded-[2rem] border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-md transition-all group flex flex-col justify-between h-full">
       <div>
          <div className="flex justify-between items-start mb-4">
             <div className="p-2 bg-white rounded-xl shadow-inner group-hover:bg-blue-50 transition-colors">
                <Zap className="w-5 h-5 text-gray-400 group-hover:text-blue-600" />
             </div>
             <span className="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-gray-100 bg-white text-gray-400 capitalize">
               {quiz.difficulty}
             </span>
          </div>
          <h4 className="text-lg font-extrabold text-gray-900 mb-4 tracking-tight group-hover:text-blue-600 transition-colors leading-snug">{quiz.title}</h4>
       </div>
       ...
       <div>
          ...
          <Link href={`/quiz/${quiz.id}?practice=true`} className="mt-6 block w-full py-3.5 bg-white group-hover:bg-blue-600 text-gray-700 group-hover:text-white rounded-xl font-black text-xs text-center border border-gray-100 group-hover:border-transparent transition-all shadow-sm">
            Start Practice
          </Link>
       </div>
    </div>
  ...
  const StageSection = ({ stageLabel, sectionQuizzes }) => {
    ...
    return (
      <div className="mb-16 bg-white p-8 md:p-12 rounded-[3.5rem] border border-gray-100 shadow-sm">
        {/* Stage Header */}
        <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
           ...
           <div>
              <h3 className="text-2xl font-black text-gray-900 tracking-tight">{stageLabel}</h3>
        ...
        {isStage1 ? (
          <div className="space-y-12">
             ...
             <div>
                <div className="mb-6">
                   <h4 className="text-lg font-black text-gray-800 flex items-center gap-2">📝 Paper I: General Studies (GS)</h4>
             ...
             <div>
                <div className="mb-6 pt-6 border-t border-gray-100">
                   <h4 className="text-lg font-black text-gray-800 flex items-center gap-2">🧠 Paper II: Civil Services Aptitude Test (CSAT)</h4>
        ...
        return (
          <div className="min-h-screen bg-gray-50/50 p-6 md:p-12">
            <div className="max-w-6xl mx-auto">
              ...
              {isPSC && (
                <div className="mb-16 bg-white p-8 md:p-10 rounded-[2.5rem] border border-gray-100 shadow-sm relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-48 h-48 bg-blue-50/30 rounded-bl-[10rem] -z-10"></div>
                  ...
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      <h2 className="text-2xl font-black text-gray-900 tracking-tight">Official Exam Scheme &amp; Pattern</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Prelims Stage */}
                    <div className="p-6 bg-gray-50/50 rounded-3xl border border-gray-100 hover:border-blue-100 transition-all flex flex-col">
                      <span className="text-xs font-black uppercase text-blue-600 tracking-widest mb-1">Stage 1</span>
                      <h3 className="text-lg font-black text-gray-900 mb-4 flex items-center gap-2">🎯 Prelims Stage <span className="text-xs font-bold text-gray-400 normal-case">(Objective MCQs)</span></h3>
                      <ul className="space-y-4 text-xs font-semibold text-gray-600 flex-grow">
                        <li className="flex items-start gap-2.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5 shrink-0"></span>
                          <div>
                            <p className="font-extrabold text-gray-900">GS Paper 1</p>
                        ...
                        <li className="flex items-start gap-2.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5 shrink-0"></span>
                          <div>
                            <p className="font-extrabold text-gray-900">CSAT Paper 2</p>
                    ...
                    {/* Mains Stage */}
                    <div className="p-6 bg-gray-50/50 rounded-3xl border border-gray-100 hover:border-purple-100 transition-all flex flex-col">
                      <span className="text-xs font-black uppercase text-purple-600 tracking-widest mb-1">Stage 2</span>
                      <h3 className="text-lg font-black text-gray-900 mb-4 flex items-center gap-2">📝 Mains Stage <span className="text-xs font-bold text-gray-400 normal-case">(Written Descriptive)</span></h3>
                      <ul className="space-y-4 text-xs font-semibold text-gray-600 flex-grow">
                        <li className="flex items-start gap-2.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-purple-500 mt-1.5 shrink-0"></span>
                          <div>
                            <p className="font-extrabold text-gray-900">Language Papers (2)</p>
                        ...
                        <li className="flex items-start gap-2.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-purple-500 mt-1.5 shrink-0"></span>
                          <div>
                            <p className="font-extrabold text-gray-900">Essay Paper (1)</p>
                        ...
                        <li className="flex items-start gap-2.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-purple-500 mt-1.5 shrink-0"></span>
                          <div>
                            <p className="font-extrabold text-gray-900">General Studies (4)</p>
                        ...
                        <li className="flex items-start gap-2.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-purple-500 mt-1.5 shrink-0"></span>
                          <div>
                            <p className="font-extrabold text-gray-900">Optional Subject (2)</p>
                    ...
                    {/* Interview Stage */}
                    <div className="p-6 bg-gray-50/50 rounded-3xl border border-gray-100 hover:border-pink-100 transition-all flex flex-col">
                      <span className="text-xs font-black uppercase text-pink-600 tracking-widest mb-1">Stage 3</span>
                      <h3 className="text-lg font-black text-gray-900 mb-4 flex items-center gap-2">🗣️ Interview Stage <span className="text-xs font-bold text-gray-400 normal-case">(Oral)</span></h3>
                      <ul className="space-y-4 text-xs font-semibold text-gray-600 flex-grow">
                        <li className="flex items-start gap-2.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-pink-500 mt-1.5 shrink-0"></span>
                          <div>
                            <p className="font-extrabold text-gray-900">Personality Test</p>
              ...
              {categoryName === 'UPSC' && pyqQuizzes.length > 0 && (
                <div className="mb-20 animate-in fade-in slide-in-from-bottom-4 duration-300">
                  ...
                  <div className="flex items-center gap-4 mb-10">
                    <div className="w-14 h-14 rounded-[1.25rem] bg-indigo-100 text-indigo-600 flex items-center justify-center text-2xl shadow-sm">🏛️</div>
                    <div>
                      <h2 className="text-3xl font-black text-gray-900 tracking-tight">Official Exam Papers (PYQs)</h2>
                      <p className="text-gray-500 font-medium mt-0.5 text-sm">Real previous year papers structured by stage and paper type.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-[3rem] border border-gray-100 shadow-sm">
                      <div className="flex items-center gap-3 mb-8 pb-4 border-b border-gray-100">
                        ...
                        <div>
                          <h3 className="text-2xl font-black text-gray-900 tracking-tight">1. Prelims Stage (Official PYQs)</h3>
                      ...
                      <div className="space-y-10">
                        ...
                        <div className="pt-6 border-t border-gray-100">
                          ...
                          <div className="bg-gray-50/50 p-8 rounded-3xl border border-dashed border-gray-200 text-center">
                            <p className="text-gray-500 font-bold text-sm">Official CSAT past papers are currently being uploaded.</p>
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-[3rem] border border-gray-100 shadow-sm">
                      <div className="flex items-center gap-3 mb-8 pb-4 border-b border-gray-100">
                        <span className="text-2xl">📝</span>
                        <div>
                          <h3 className="text-2xl font-black text-gray-900 tracking-tight">2. Mains Stage (Official PYQs)</h3>
